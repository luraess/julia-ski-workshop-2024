...
ax = (surf=Axis(fig[1, 1][1, 1]; aspect=DataAspect(), title="surface", ylabel="y"),
      ...
      slip=(syn=Axis(fig[1, 2][1, 1]; aspect=DataAspect(), title="synthetic slipperiness"),
            mod=Axis(fig[3, 2][1, 1]; aspect=DataAspect(), title="modeled slipperiness")),
